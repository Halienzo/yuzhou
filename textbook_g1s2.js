...
/* ═══════════════════════════════════════════ */
{
  ...
  lessons: [
    ...
    {id:6,title:"树和喜鹊",titleEn:"The Tree and the Magpie",
      ...
      textPinyin:["cóng qián, zhè lǐ zhǐ yǒu yī kē shù, shù shàng zhǐ yǒu yī gè niǎo wō, niǎo wō lǐ zhǐ yǒu yī zhī xǐ què.","shù hěn gū dān, xǐ què yě hěn gū dān.","hòu lái, zhè lǐ zhǒng le hǎo duō hǎo duō shù...","shù yǒu le lín jū, xǐ què yě yǒu le lín jū.","měi tiān tiān yī liàng, xǐ què men jī ji zhā zhā jiào jǐ shēng...","shù hěn kuài lè, xǐ què yě hěn kuài lè."],
...
/* ═══════════════════════════════════════════ */
{
  ...
  lessons: [
    ...
    {id:10,title:"端午粽",titleEn:"Dragon Boat Festival Rice Dumplings",
      ...
      textPinyin:["yī dào duān wǔ jié, wài pó zǒng huì zhǔ hǎo yī guō zòng zi, pàn zhe wǒ men huí qù.","zòng zi shì yòng qīng qīng de ruò zhú yè bāo de...","wài pó bāo de zòng zi shí fēn hǎo chī, huā yàng yě duō...","zhǎng dà le wǒ cái zhī dào, rén men duān wǔ jié chī zòng zi, jù shuō shì wèi le jì niàn ài guó shī rén qū yuán."],
    ...
    {id:11,title:"彩虹",titleEn:"Rainbow",
      ...
      textPinyin:["yǔ tíng le, tiān shàng yǒu yī zuò měi lì de qiáo.","bà ba, nǐ nà bǎ jiāo huā yòng de shuǐ hú ne?...","mā ma, nǐ shū tóu yòng de nà miàn jìng zi ne?...","gē ge, nǐ jì zài mén qián shù shàng de qiū qiān ne?..."],
...
/* ═══════════════════════════════════════════ */
{
  ...
  lessons: [
    ...
    {id:7,title:"操场上",titleEn:"On the Playground",
      text:["铃声响，下课了，","操场上，真热闹。","跳绳踢毽丢沙包，","天天锻炼身体好。","打球  拔河  拍皮球","跑步  踢足球  跳高","铃声响，上课了，","操场上，静悄悄。"],
      textEn:["The bell rings, class is over,","The playground is bustling.","Jumping rope, kicking shuttlecocks, tossing sandbags,","Daily exercise keeps you healthy.","Playing ball  Tug-of-war  Bouncing balls","Running  Playing soccer  High jump","The bell rings, class begins,","The playground is quiet."],
      textPinyin:["líng shēng xiǎng, xià kè le,","cāo chǎng shàng, zhēn rè nào.","tiào shéng tī jiàn diū shā bāo,","tiān tiān duàn liàn shēn tǐ hǎo.","dǎ qiú  bá hé  pāi pí qiú","pǎo bù  tī zú qiú  tiào gāo","líng shēng xiǎng, shàng kè le,","cāo chǎng shàng, jìng qiāo qiāo."],
...
/* ═══════════════════════════════════════════ */
{
  ...
  lessons: [
    {id:12,title:"古诗二首",titleEn:"Two Ancient Poems",
      text:["池上","小娒撑小艇，偷采白莲回。","不解藏踪迹，浮萍一道开。","小池","泉眼无声惜细流，","树阴照水爱晴柔。","小荷才露尖尖角，","早有蜻蜓立上头。"],
    ...
    {id:13,title:"荷叶圆圆",titleEn:"Round, Round Lotus Leaves",
      ...
      textPinyin:["hé yè yuán yuán de, lǜ lǜ de.","xiǎo shuǐ zhū shuō: 'hé yè shì wǒ de yáo lán.'...","xiǎo qīng tíng shuō: 'hé yè shì wǒ de tíng jī píng.'...","xiǎo qīng wā shuō: 'hé yè shì wǒ de gē tái.'...","xiǎo yú er shuō: 'hé yè shì wǒ de liáng sǎn.'..."],
    ...
    {id:14,title:"要下雨了",titleEn:"It's Going to Rain",
      ...
      textEn:["Little White Rabbit was bending down cutting grass on the hillside. The weather was stuffy. He straightened up and stretched.","A swallow flew over his head. 'Swallow, swallow, why are you flying so low?'","The swallow said while flying: 'It's going to rain. The air is humid, the insects' wings are wet with water drops — they can't fly high, and I'm busy catching them!'","Is it really going to rain? Rabbit looked at the nearby pond — the fish had all come to the surface.","'Little fish, why are you out today?'","'It's going to rain! The water is stuffy — we came to the surface for air. Go home quick before you get wet!'","Rabbit quickly grabbed his basket and ran home. He saw ants moving house by the road.","He told the ants the news about the rain.","And the heavy rain really did start pouring!"],
      textPinyin:["xiǎo bái tù wān zhe yāo zài shān pō shàng gē cǎo...","xiǎo yàn zi cóng tā tóu shàng fēi guò...","yàn zi biān fēi biān shuō: 'yào xià yǔ le...'","...xiǎo yú dōu yóu dào shuǐ miàn shàng lái le.","...","xiǎo yú shuō: 'yào xià yǔ le, shuǐ lǐ mēn de hěn...'","...xiǎo mǎ yǐ zhèng zài bān jiā ne.","...","dà yǔ zhēn de xià qǐ lái le!"],
...
/* ═══════════════════════════════════════════ */
{
  ...
  lessons: [
    {id:15,title:"文具的家",titleEn:"Where Stationery Lives",
      ...
      textEn:["As soon as Beibei got home, she asked Mama for new pencils and erasers. Mama said: 'Why do you lose things every day?'","Beibei blinked her big eyes: 'I don't know either.'","Mama said: 'Beibei, you have a home, and you come back safely every day. Think — do your pencils and erasers have a home?'","Beibei remembered — the pencil case in her bag is the home for pencils and erasers!","From then on, every day after school, Beibei carefully checked that all her little friends — pencils, erasers, sharpener — had all gone home."],
      textPinyin:["bèi bei yī huí dào jiā, jiù xiàng mā ma yào xīn de qiān bǐ, xīn de xiàng pí...","bèi bei zhǎ zhe yī shuāng dà yǎn jīng...","mā ma shuō: 'bèi bei, nǐ yǒu yī gè jiā...'","bèi bei xiǎng qǐ lái le...","cóng cǐ, měi tiān fàng xué de shí hou..."],
    ...
    {id:16,title:"一分钟",titleEn:"One Minute",
      ...
      textEn:["Ring ring, the alarm went off. Yuanyuan yawned and rolled over, thinking: just one more minute, just one minute, I won't be late.","After one minute, Yuanyuan got up. He quickly washed his face, ate breakfast, and headed to school.","At the crossroads, the light was green, but just as he started to cross, it turned red. He sighed: 'If only I'd been one minute earlier.'","After waiting, he ran toward the bus at the stop — but the bus left. He sighed again: 'If only I'd been one minute earlier.'","He waited and waited, but no bus came. He decided to walk to school.","At school, class had already started. Yuanyuan sat down at his seat, red-faced and head down.","The teacher looked at her watch: 'Yuanyuan, you're twenty minutes late today.'","Yuanyuan deeply regretted it."],
      textPinyin:["dīng líng líng, nào zhōng xiǎng le. yuán yuan dǎ le gè hā qian...","guò le yī fēn zhōng, yuán yuan qǐ lái le...","...hóng dēng liàng le. tā tàn le kǒu qì...","...chē zi kāi le. tā tàn le kǒu qì...","...yuán yuan jué dìng zǒu dào xué xiào qù.","...yuán yuan hóng zhe liǎn, dī zhe tóu...","...jīn tiān nǐ chí dào le èr shí fēn zhōng.","yuán yuan fēi cháng hòu huǐ."],
    ...
    {id:17,title:"动物王国开大会",titleEn:"The Animal Kingdom Holds a Meeting",
      text:["动物王国要开大会，老虎让狗熊通知大家。","狗熊用喇叭大声喊：\u201C大家注意，动物王国要开大会，请你们都参加！\u201D","一直到晚上，动物们都没来。","狗熊问老虎。老虎说：\u201C你没有说清楚是明天还是今天，大家不知道什么时候开会。\u201D","狗熊又用喇叭喊：\u201C大家注意，明天开大会，请你们都参加！\u201D","第二天，动物们还是没来。","老虎说：\u201C你没说清在哪里开会。\u201D","狗熊又喊：\u201C明天上午八点，在森林广场开大会！\u201D","第二天上午八点，动物们都到了森林广场。大会终于开成了！"],
      textEn:["The Animal Kingdom was going to hold a meeting. Tiger asked Bear to notify everyone.","Bear shouted through a megaphone: 'Attention everyone! The Animal Kingdom is holding a meeting — please attend!'","By evening, no animals had come.","Bear asked Tiger. Tiger said: 'You didn't say whether it's today or tomorrow. Nobody knows when!'","Bear shouted again: 'Attention! Meeting tomorrow — please attend!'","The next day, still no one came.","Tiger said: 'You didn't say where.'","Bear shouted: 'Tomorrow at 8 AM, at Forest Square!'","At 8 AM the next day, all the animals arrived at Forest Square. The meeting finally happened!"],
      textPinyin:["dòng wù wáng guó yào kāi dà huì, lǎo hǔ ràng gǒu xióng tōng zhī dà jiā.","gǒu xióng yòng lǎ ba dà shēng hǎn...","yī zhí dào wǎn shàng, dòng wù men dōu méi lái.","...nǐ méi yǒu shuō qīng chǔ shì míng tiān hái shì jīn tiān...","...","...","...nǐ méi shuō qīng zài nǎ lǐ kāi huì.","...míng tiān shàng wǔ bā diǎn, zài sēn lín guǎng chǎng kāi dà huì!","...dà huì zhōng yú kāi chéng le!"],
    ...
    {id:18,title:"小猴子下山",titleEn:"Little Monkey Goes Down the Mountain",
      ...
      textEn:["One day, Little Monkey came down the mountain. In a cornfield, he saw big, plentiful corn, happily picked one, and carried it forward.","Carrying the corn, he passed a peach tree. Seeing big, red peaches, he happily threw away the corn to pick peaches.","Holding peaches, he came to a melon patch. Seeing big, round watermelons, he threw away the peaches to pick watermelon.","Carrying a big watermelon, he saw a cute little rabbit hopping around, threw the watermelon, and chased the rabbit.","The rabbit ran into the forest and disappeared. Little Monkey had to go home empty-handed."],
      textPinyin:["yǒu yī tiān, xiǎo hóu zi xià shān lái...","xiǎo hóu zi káng zhe yù mǐ, zǒu dào yī kē táo shù xià...","xiǎo hóu zi pěng zhe jǐ gè táo zi, zǒu dào yī piàn guā dì lǐ...","xiǎo hóu zi bào zhe yī gè dà xī guā wǎng huí zǒu...","xiǎo tù zi pǎo jìn shù lín lǐ, bù jiàn le..."],
...
/* ═══════════════════════════════════════════ */
{
  ...
  lessons: [
    {id:19,title:"棉花姑娘",titleEn:"Miss Cotton",
      ...
      textEn:["Miss Cotton was sick — hateful aphids covered her leaves. How she wished a doctor would come!","A swallow came. 'Please help me catch the pests!' 'Sorry, I only catch insects flying in the air. You should ask someone else!'","A woodpecker came. 'Please help me!' 'Sorry, I only catch insects inside tree trunks. Ask someone else!'","A frog hopped over. 'Please help me!' 'Sorry, I only catch insects in the fields. Ask someone else!'","Suddenly, a group of round little bugs flew in and quickly ate all the aphids. 'Who are you?' asked Miss Cotton in surprise. 'We are seven-spot ladybugs — we specialize in eating aphids!'","Soon Miss Cotton recovered, growing lush green leaves and producing snow-white cotton. She grinned with joy!"],
      textPinyin:["mián hua gū niang shēng bìng le...","yàn zi fēi lái le...","zhuó mù niǎo fēi lái le...","qīng wā tiào lái le...","hū rán, yī qún yuán yuán de xiǎo chóng zi fēi lái le...","bù jiǔ, mián hua gū niang de bìng hǎo le..."],
    ...
    {id:20,title:"咕咚",titleEn:"Gudong!",
      ...
      textEn:["A papaya was ripe. It fell from the tall tree into the lake — 'Gudong!'","Rabbit was startled and ran.","Monkey asked why. Rabbit ran and yelled: 'Oh no! Gudong is coming! Run!'","Monkey started running and yelling too: 'Gudong is coming! Run!'","Now everyone panicked. Fox, goat, deer — one after another they ran. 'Run for your lives! Gudong is coming!'","Elephant joined the stampede. Buffalo stopped him: 'Where is Gudong? Did you see it?' Elephant: 'No, everyone says it's coming.' Buffalo asked everyone — nobody had seen it. Finally, Rabbit said: 'I heard it! Gudong is in that lake over there.'","Rabbit led everyone to the lake. Just then, another papaya fell — 'Gudong!'","Everyone looked at each other and laughed."],
      textPinyin:["mù guā shú le. yī gè mù guā cóng gāo gāo de shù shàng diào jìn hú lǐ, 'gū dōng'!","tù zi xià le yī tiào, bá tuǐ jiù pǎo.","...tù zi yī biān pǎo yī biān jiào: 'bù hǎo la, gū dōng lái le...'","...","...","...yě niú lán zhù tā, wèn: 'gū dōng zài nǎ lǐ?'...","tù zi lǐng zhe dà jiā lái dào hú biān...'gū dōng'!","dà huǒ nǐ kàn kan wǒ, wǒ kàn kan nǐ, dōu xiào le."],
    ...
    {id:21,title:"小壁虎借尾巴",titleEn:"Little Gecko Borrows a Tail",
      ...
      textEn:["Little Gecko was catching mosquitoes on a wall when a snake bit his tail. He struggled free, breaking off his tail to escape.","Without a tail — how ugly! 'Who can I borrow a tail from?'","He crawled to the river: 'Fish sister, may I borrow your tail?' 'No, I need it to swim!'","He climbed a big tree: 'Uncle Ox, may I borrow your tail?' 'No, I need it to swat flies!'","He crawled under the eaves: 'Aunt Swallow, may I borrow your tail?' 'No, I need it to steer!'","Gecko couldn't borrow a tail and felt sad. He crawled home to Mama.","Mama smiled: 'Silly child, turn around and look.' Gecko turned and happily cried: 'I've grown a new tail!'"],
      textPinyin:["xiǎo bì hǔ zài qiáng jiǎo zhuō wén zi...","méi yǒu wěi ba duō nán kàn na...","xiǎo bì hǔ pá ya pá, pá dào xiǎo hé biān...","xiǎo bì hǔ pá ya pá, pá dào dà shù shàng...","xiǎo bì hǔ pá ya pá, pá dào fáng yán xià...","xiǎo bì hǔ jiè bù dào wěi ba, xīn lǐ hěn nán guò...","mā ma xiào zhe shuō: 'shǎ hái zi, nǐ zhuǎn guò shēn zi kàn kan.'..."],
